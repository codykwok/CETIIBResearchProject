...
for runnumber = 21:21 % Input run number between 21-29, can input multiple or individual runs
    ...
    ovencookingenergy = heatpseudochicken(cutovenloc,PCwaterstart(runnumber-30),PCwaterfinish(runnumber-30));
    ...
    totalenergy = airoutenergy+ovencookingenergy+heatlossovenouts+heatlosscuouts+tubingloss;
    discrepancy = (batenergy-totalenergy)/batenergy*100;
    efficiency = ovencookingenergy / totalenergy;
    table(runnumber,batend(runnumber-30)-batstart(runnumber-30),batenergy,totalenergy,round(discrepancy,2),heatlossovenouts,tubingloss,airoutenergy,ovencookingenergy,'VariableNames',{'Runnumber','Elapsed Time (s)','Measured Energy (J)','Calculated Energy (J)','Energy Discrepancy (%)','Oven Loss (J)','Tubing Loss (J)','Air Out Loss (J)','Oven Cooking Energy (J)'})
